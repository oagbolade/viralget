            ...
            <div class="tweet-margin col-md-4">
              ...
              <table class="table bg-white shadow table-hover table-striped">
                <paginate
                  ...
                  tag="tbody"
                >
                  <tr v-if="high_retweets.length == 0">
                    <td><h6>No data available</h6></td>
                  </tr>
                  <tr
              ...
              <div class="tweet-margin col-md-6">
                ...
                <table class="table shadow bg-white table-hover table-striped">
                  <paginate
                    ...
                    tag="tbody"
                  >
                    <tr v-if="original_contributors.length == 0">
                      <td><h6>No data available</h6></td>
                    </tr>
                    <tr
              ...
              <div class="tweet-margin col-md-6">
                ...
                <table class="table shadow bg-white table-hover table-striped">
                  <paginate
                    ...
                    tag="tbody"
                  >
                    <tr v-if="top_original_contributors.length == 0">
                      <td><h6>No data available</h6></td>
                    </tr>
                    <tr
                      v-for="(active, index) in paginated(
                ...
                <div class="tweet-margin col-lg-4">
                  ...
                  >
                    <paginate
                      ...
                      tag="tbody"
                    >
                      <tr v-if="most_recent_tweets.length == 0">
                        <td>
                ...
                <div class="tweet-margin col-md-4">
                  ...
                  >
                    <paginate
                      ...
                      tag="tbody"
                    >
                      <tr v-if="most_recent_replies.length == 0">
                        <td>
                          <h6>No data available</h6>
                        </td>
                      </tr>
      ...
      fetch(`/api/v1/report/hashtag/${this.id}`, {
        ...
        .then((res) => {
          if (res.status == "success" && res.data) {
            ...
            // High Tweets
            const get_most_recent_tweets = JSON.parse(
              res.high_tweets.most_recent_tweets
            );
            const get_most_recent_replies = JSON.parse(
              res.high_tweets.most_recent_replies
            );
            ...
            // Contributors
            const get_original_contributors = JSON.parse(
              res.contributors.original_contributors
            );
            const get_top_original_contributors = JSON.parse(
              res.contributors.top_original_contributors
            );
