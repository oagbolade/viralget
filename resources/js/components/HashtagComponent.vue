                        ...
                        <div class="row">
                            ...
                            <div class="tweet-margin col-md-6">
                                ...
                                >
                                    ...
                                    >
                                        <tr
                                            v-if="
                                                top_original_contributors.length ==
                                                    0
                                            "
                                        >
                                            <td><h6>No data available</h6></td>
                            ...
                            <div class="row">
                                <div class="tweet-margin col-lg-4">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p>
                                                        <i
                                                            class="fa fa-retweet text-primary"
                                                        ></i>
                                                        {{
                                                            active.tweet_data
                                                                .retweet_count
                                    ...
                                    <paginate-links
                                        v-if="
                                            !exceptPlans.includes(report_type)
                                        "
...
export default {
    ...
    methods: {
            ...
            fetch(`/api/v1/report/hashtag/${this.id}`, {
                ...
                .then(res => {
                    if (res.status == "success") {
                        ...
                        this.top_original_contributors =
                            data.top_original_contributors;
        ...
        goTo() {
            if (
                this.report_type === "starter" ||
                this.report_type === "basic"
            ) {
                Swal.fire(
                    "Sorry!",
