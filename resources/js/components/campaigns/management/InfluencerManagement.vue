    ...
    <div class="container">
        ...
        <div class="row gap-y" v-show="displayError && !loading">
            <div class="col-md-10 mx-auto text-center">
                ...
                <h1>Oops!</h1>
                <h3>
                    Unfortunately, we're unable to access your campaigns at the
                    moment.
                </h3>
        ...
        <div class="row" v-show="!loading && !displayError">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h6 id="block-2">
                        Monitor hastag campaigns, generate reports and listen to
                        what people online are saying about your brand
                    </h6>
                </div>
                ...
                >
                    <table class="table table-hover responsive">
                        ...
                        >
                            <tr
                                v-for="(campaign, index) in paginated(
                                    'campaigns'
                                )"
                                :key="index"
                            >
                                ...
                                <td>
                                    <strong>{{
                                        makeCamelCase(campaign.user_query)
                                    }}</strong>
                                </td>
                                <td>
                                    <div>
