            ...
            <div class="report-data col-lg-8">
                <h6 id="block-2" class="block-number">
                  Profiling report for:
                    <strong>{{ decodeURIComponent(handle) }} </strong> with the
                    hashtag #{{ keyword }}
                </h6>
                                ...
                                >
                                    ...
                                    <tr v-if="recent_tweets.length == 0">
                                      <td><h6>No data available</h6></td>
                                        ...
                                        <tr
                                            v-for="(tweet, index) in paginated(
                                                'recent_tweets'
                                            )"
                                            :key="index"
                                        >
                        ...
                        <div class="row gap-y">
                            ...
                            >
                                ...
                                <div class="text-center">
                                    <a
                                        href="/contact"
                                        class="btn btn-warning mt-5 mb-7"
                                        >Contact Us</a
                                    >
                                </div>
                            </div>
