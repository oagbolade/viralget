    ...
    >
      <div class="pt-5 text-center">
        ...
        <h5 class="card-title mt-5">
          <a :href="`/search/profile/${handle}`" v-show="screen_name">{{
            screen_name
          }}</a
          ><br />
      ...
      <!-- Save profile json data to use color and name -->
      ...
      <div id="category-name" class="badges py-3 text-center">
        <a class="badge badge-primary">{{ profile.category.name }}</a>
      ...
      <div class="text-center p-5">
        <a class="btn btn-warning" :href="`/search/profile/${profile.handle}`"
          >View Stats</a
        >
      </div>
    </div>
