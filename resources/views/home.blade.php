...
ViralGet is an easy-to-use platform that matches you with the right influencers and offers targeted and measured campaigns.</p>
              ...
              {{-- profiles --}}
              <a class="btn btn-xl btn-round btn-warning w-350 mr-3 px-6 d-md-inline-block home-btn" href="{{ route('search') }}">Get started <span class="ti-arrow-right"></span></a>
            </div>
    ...
    <main class="main-content">
      ...
      <section class="section bg-white ">
        <div class="container">
          <header class="section-header">
            ...
            <hr>
            <p class="lead">We match you with influencers that matches your brand needs</p>
          </header>
        ...
        <div class="container">
          <div class="row gap-y align-items-center">
            ...
            <div class="col-lg-6 mx-auto">
              ...
              <p class="mb-7">We serve as the bridge between brands and influencers, by finding the perfect Influencer for your campaigns through audience insight. This way you’re not just influencing, you’re INTELLIFLUENCING. </p>
              ...
              <p class="mt-6">
                <a class="text-uppercase fw-600 ls-2 small-2" href="{{ route('about') }}">Learn More <i class="ti-arrow-right fs-10 ml-1"></i></a>
              </p>
            </div>
      ...
      <section class="section text-white pb-0 overflow-hidden homepage-tabs" style="background-color: #f64d62">
        ...
        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="find-tab" data-toggle="tab" href="#find" role="tab" aria-controls="find" aria-selected="true">
              <p class="lead-5"><i class="icon-search"></i></p>
              <h2>Find</h2>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="hire-tab" data-toggle="tab" href="#hire" role="tab" aria-controls="hire" aria-selected="false">
          ...
          <li class="nav-item">
            <a class="nav-link" id="manage-tab" data-toggle="tab" href="#manage" role="tab" aria-controls="manage" aria-selected="false">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="find-tab">
            ...
            <div class="col-md-6 pb-8">
              <!-- <h2>Find</h2> -->
              <p>Don't just get Influencers, find the perfect Influencers for your campaign through our platform, by getting profile and  audience insight. This way you’re not just influencing, you’re INTELLIFLUENCING.</p>
            </div>

            <div class="col-md-6 align-self-center text-center">
              <i class="icon-search aos-init aos-animate hide-mobile" data-aos="fade-up" style="font-size: 150px;  margin-top: -97px;" ></i>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="hire" role="tabpanel" aria-labelledby="hire-tab">
            ...
            <div class="col-md-6 pb-8">
              <!-- <h2>Hire</h2> -->
              <p>Now that you’ve found the perfect Influencers, or maybe not; we’ll gladly do the finding for you. Reach out to us to help you hire them, it’s our turf we understand it better.</p>
            </div>

            <div class="col-md-6 align-self-center text-center">
              <i class="icon-toolbox aos-init aos-animate hide-mobile" data-aos="fade-up" style="font-size: 150px;  margin-top: -97px;" ></i>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="content" role="tabpanel" aria-labelledby="content-tab">
            ...
            <div class="col-md-6 pb-8">
              ...
              <p>For us, content is key and the life to every influencing marketing campaigns. We take keen interest in ensuring all contents resonates with the brands campaign objectives, and in a creative way.</p>
            </div>

            <div class="col-md-6 align-self-center text-center">
              <i class="fa fa-file-o aos-init aos-animate hide-mobile" data-aos="fade-up" style="font-size: 150px;  margin-top: -97px;" ></i>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="manage" role="tabpanel" aria-labelledby="manage-tab">
            ...
            <div class="col-md-6 pb-8">
              <!-- <h2>Manage</h2> -->
              <p>Someone’s gotta ensure these guys are not deviating and are timely with delivery, Ooh yeah, that’s our job. We’ll manage them.</p>
            </div>

            <div class="col-md-6 align-self-center text-center">
              <i class="fa fa-laptop aos-init aos-animate hide-mobile" data-aos="fade-up" style="font-size: 150px;  margin-top: -97px;" ></i>
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="report" role="tabpanel" aria-labelledby="report-tab">
            ...
            <div class="col-md-6 pb-8">
              ...
              <p>While you can track your campaign and see how it’s performing here(hyperlink). We’ll send you a detailed report on how your  campaign performed in comparison to your KPIs</p>
            </div>

            <div class="col-md-6 align-self-center text-center">
              <i class="icon-linegraph aos-init aos-animate hide-mobile" data-aos="fade-up" style="font-size: 150px;  margin-top: -97px;" ></i>
       ...
       <canvas class="constellation" data-color="rgba(255,255,255,0.3)" width="1366" height="625"></canvas>
        <div class="container">
          <div class="col-md-8 offset-md-2">
            <div class="slider-dots-fill text-white text-center" data-autoplay="true" data-provide="slider" data-dots="false">
              <div>
                <blockquote class="blockquote">
                  <h3>3 Things are key to a successful Influencer marketing; Content, Story Telling and Consumer Experience.</h3>
                </blockquote>
              </div>
              <div>
                <blockquote class="blockquote">
              ...
              <div>
                <blockquote class="blockquote">
                  <h3> We ensure influencers don’t work as a single entity, we collaborate as ONE for your brands objective</h3>
                </blockquote>
              </div>
              <div>
                <blockquote class="blockquote">
              ...
              <div>
                <blockquote class="blockquote">
                  <h3> Don't just go viral, be intelligent about your VIRALIZATION. It’s not that difficult, we can help.</h3>
                </blockquote>
              </div>
              <div>
                <blockquote class="blockquote">
                  <h3> Biggest mistake with utilizing Influencers is when you activate the individual. The power of Influencers is in their collectiveness.</h3>
                </blockquote>
              </div>
            </div>
            <p class="text-center"><a class="btn btn-lg btn-round btn-warning" href="{{ route('marketing') }}">Learn about Influencer Marketing <span class="ti-arrow-right"></span> </a></p>
          </div>
        ...
        <div class="container">
          <div class="row gap-y align-items-center">
            <div class="col-md-12 text-center text-center">
              <h2 class="text-white">Analyze, classify and display your Twitter Influencers</h2>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 mx-auto">
              <div class="slider-center-focused" data-autoplay="true" data-provide="slider" data-slides-to-show="3" data-center-mode="true"  data-dots="true">
                <div class="p-2"><img src="{{ asset('./static/assets/img/portfolio/lasg.png') }}" alt="LASG"></div>
                <div class="p-2"><img src="{{ asset('./static/assets/img/portfolio/gtb.png') }}" alt="LASG"></div>
                <div class="p-2"><img src="{{ asset('./static/assets/img/portfolio/pwc.png') }}" alt="LASG"></div>
                <div class="p-2"><img src="{{ asset('./static/assets/img/portfolio/shoprite.png') }}" alt="LASG"></div>
              </div>
            </div>
          </div>
        </div>
