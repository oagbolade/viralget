        ...
        @csrf
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="company_name" class="form-control form-control-lg" placeholder="e.g Viralget Limited">
                </div>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="position" class="form-control form-control-lg" placeholder="Your position at the company/agency">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea name="campaign_objective" class="form-control form-control-lg" placeholder="Campaign Objective"></textarea>
              </div>
