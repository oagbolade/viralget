            ...
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                ...
                <p class="text-center py-3">
                  <a class="btn btn-block btn-primary text-uppercase" href="{{ route('managements.signup', ['bookingType' => 'influencer_management', 'plan' => 1])}}" data-bind-href="pricing" data-monthly="#monthly" data-yearly="#yearly">
          ...
          <div class="col-lg-4">
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                ...
                <p class="text-center py-3">
                  <a class="btn btn-block btn-warning text-uppercase" href="{{ route('managements.signup', ['bookingType' => 'influencer_management', 'plan' => 2])}}" data-bind-href="pricing" data-monthly="#monthly" data-yearly="#yearly">
                  @if($user && $user->subscription && $user->subscription->plan->name != 'enterprise') 
                    Get Started 
                  @else
                    Get Started
          ...
          <div class="col-lg-4">
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                ...
                <p class="text-center py-3">
                  <a class="btn btn-block btn-success text-uppercase" href="{{ route('managements.signup', ['bookingType' => 'influencer_management', 'plan' => 3])}}" data-bind-href="pricing" data-monthly="#monthly" data-yearly="#yearly">
                  @if($user && $user->subscription && $user->subscription->plan->name != 'enterprise') 
                    Get Started
                  @else
                    Get Started
