...
<body>
            ...
            <div class="vertical-center float-right">
              <span class="small text-uppercase block-number ls-2" id="block-2">
                <h6 id="block-2" class="block-number">
                  {{ $extra_data['report_type_days'] }} days profiling report for: {{ $data->profile->screen_name }}
                  <br>
                </h6>
              </span>
              <div>
                <small>
                  <span></span> &nbsp; {{ $data->date_from }} -
                  {{ $data->date_to }}
                </small>
              </div>
            </div>
            ...
            <div class="container">
              <div class="row gap-y">
                <div class="col-md-6 text-center">
                  <img class="rounded-circle" width="200px"
                    src="{{ str_replace("_normal", "", $data->profile->profile_image_url) }}" :alt="name" />
                  <br />
                  <div class="row">
                    <div class="col-md-8 mx-md-auto">
                      <h5>About {{ $data->profile->name }}</h5>
                      <h6>{{ $data->profile->screen_name }}</h6>
                      <p>{{ $data->profile->description }}</p>
                      <p><i class="icon-scope"></i> {{ $data->profile->location }}</p>
                    </div>
                  </div>
                </div>
          ...
          <td>
            <div class="col-md-6 mx-md-auto">
              <div class="row gap-y text-center">
                <div width="33%" class="col-4">
                  <p>Engagement Rate</p>
                  <h2 data-provide="countup" data-from="0" :data-to="engagementRate" data-suffix="%" class="counted">
                ...
                <div width="33%" class="col-4">
                  <p>Reach<br /><br /></p>
                  <h2 data-provide="countup" data-from="0" :data-to="averageLikes" class="counted">
                    {{ number_format($data->reach) }}
                  </h2>
                </div>

                <div width="33%" class="col-4">
                  <p>Total Engagements</p>
                  <h2 data-provide="countup" data-from="0" :data-to="averageRetweets" class="counted">
              ...
              <div class="row gap-y text-center">
                <div width="33%" class="col-3">
                  <p>Total Posts</p>
                  <h2 data-provide="countup" data-from="0" :data-to="parseInt(numberFormat(totalTweets))"
                    class="counted">
                    {{ number_format($data->total_posts) }}
                  </h2>
                </div>
                ...
                <div width="33%" class="col-4">
                  <p>Avg Likes<br /><br /></p>
                  <h2 data-provide="countup" data-from="0" :data-to="averageLikes" class="counted">
                    {{ number_format($data->avr_likes) }}
                  </h2>
                </div>

                <div width="33%" class="col-4">
                  <p>Avg Retweets<br /><br /></p>
                  <h2 data-provide="countup" data-from="0" :data-to="averageRetweets" class="counted">
                    {{ number_format($data->avr_retweets) }}
                  </h2>
                </div>
              </div>
              ...
              <div class="row gap-y text-center">
                <div width="50%" class="col-4">
                  <p>Followers</p>
                  <h2 data-provide="countup" data-from="0" :data-to="parseInt(numberFormat(followers))"
                    data-duration="10" data-use-easing="false" class="counted">
                    {{ number_format($data->profile->followers_count) }}
                  </h2>
                </div>
  ...
  <div style="page-break-inside: always;" class="container">
    <div class="row">
        ...
        <tr>
          <td width="50%">
            <div class="">
              ...
              <table class="table shadow bg-white table-hover table-striped">
                @foreach(array_slice($data->retweets, 0, 5) as $retweetData)
                <tr style="page-break-inside: avoid;" {{ ($loop->index == 3) ? 'style="page-break-inside: avoid;"' : '' }}>
                  <td width="50%">
                    <div class="media mb-3">
                      <div class="lead-6 line-height-1 text-danger w-50px">
                        <img class="avatar avatar-sm" src="{{ $retweetData->user->profile_image_url }}" alt="" />
                      </div>
                    ...
                    <p>
                      <small>
                        <strong>Posted on
                          {{ \Carbon\Carbon::parse($retweetData->created_at)->toDayDateTimeString() }}
                        </strong>
                      </small>
                    </p>
                    <p>
          ...
          <td width="50%">
            <div class="">
              ...
              <table class="table shadow bg-white table-hover table-striped">
                @foreach(array_slice($data->recent_tweets, 0, 5) as $tweetData)
                <tr>
                  <td width="50%">
                    <div class="media mb-3">
                      <div class="lead-6 line-height-1 text-danger w-50px">
                        <img class="avatar avatar-sm" src="{{ $tweetData->user->profile_image_url }}" alt="" />
                      </div>
                      <div class="media-body">
