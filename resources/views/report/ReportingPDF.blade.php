    ...
    <div class="container">
        <table class="table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="vertical-center float-right">
                            <span class="small text-uppercase block-number ls-2" id="block-2">
                                <h6 id="block-2" class="block-number">
                                    {{ $extra_data['report_type_days'] }} days report for the keyword:
                                    {{ $extra_data['handle'] }}<br>
                                </h6>
                            </span>
                ...
                <tr class="capital-stats">
                    <td>
                        <div class="capital-padding">
                            ...
                            <div class="text-center">
                                <p class="lead-8 lh-1 fw-700 counted">
                    ...
                    <td>
                        <div class="capital-padding">
                            ...
                            <div class="text-center">
                                <p class="lead-8 lh-1 fw-700 counted">
                                    {{ number_format($data->potential_reach) }}
                                </p>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="capital-padding">
                            ...
                            <div class="text-center">
                                <p class="lead-8 lh-1 fw-700 counted">
                                    {{ number_format($data->campaign_value) }}
                                </p>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->media_meta_data->text->count) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->media_meta_data->media->count) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->contributors) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->avr_contribution) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->high_likes->count) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->accurate_engagement_rate, 2) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format($data->total_engagements) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                    <td class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="lead-7 pl-2 text-right counted float-right">
                                    {{ number_format(($data->total_engagements / $data->potential_reach) * 100, 2) }}
                                </h4>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td width="33.3%">
                        <div class="tweet-margin">
                            ...
                            <table class="table bg-white shadow table-hover table-striped">
                                @foreach(array_slice($data->most_active->data, 0, 5) as $tweetData)
                                <tr>
                                    <td width="70%">
                                        <div class="media">
                                            <div class="lead-6 line-height-1 text-danger w-50px">
                                                <img class="avatar avatar-sm"
                                                    src="{{ $tweetData->user->profile_image_url }}" alt="" />
                                            </div>
                                    ...
                                    <td class="text-center">
                                        <strong>{{ $tweetData->count }}</strong><br /><small>Contributions</small>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                    ...
                    <td width="33.3%">
                        <div class="tweet-margin">
                            <h3>Retweeters</h3>
                            <table class="table bg-white shadow table-hover table-striped">
                                @foreach(array_slice($data->retweets->data, 0, 5) as $tweetData)
                                <tr>
                                    <td width="70%">
                                        <div class="media">
                                            <div class="lead-6 line-height-1 text-danger w-50px">
                                    ...
                                    <td class="text-center">
                                        <strong>{{ $tweetData->count }}</strong><br /><small>Retweeters</small>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                    ...
                    <td width="33.3%">
                        <div class="tweet-margin">
                            <h3>High Impacts</h3>
                            <table class="table bg-white shadow table-hover table-striped">
                                @foreach(array_slice($data->high_impacts, 0, 5) as $tweetData)
                                <tr>
                                    <td width="70%">
                                        <div class="media">
                                            <div class="lead-6 line-height-1 text-danger w-50px">
                                    ...
                                    <td class="text-center">
                                        <strong>{{ $tweetData->count }}</strong><br /><small>Impacts</small>
                                    </td>
                                </tr>
                                @endforeach
                            </table>
                    ...
                    <tr>
                        <td>
                            ...
                            <table class="table shadow bg-white table-hover table-striped">
                                @foreach(array_slice(json_decode($high_tweets['most_recent_tweets']), 0, 5) as
                                $tweetData)
                                <tr>
                                    <td class="high-tweets" width="70%">
                                        <div class="media mb-3">
                                            <div class="lead-6 line-height-1 text-danger w-50px">
                                                <img class="avatar avatar-sm"
                                                    src="{{ $tweetData->tweet_data->user->profile_image_url }}"
                                                    alt="" />
                                            </div>
                                            <div class="media-body">
                                                <strong>{{ '@'.$tweetData->tweet_data->user->screen_name }}</strong><br />
                                                <small>{{ $tweetData->tweet_data->user->name }}</small>
                                            </div>
                                        </div>
                                        <p>
                                            {{ $tweetData->tweet_data->text }}
                                        </p>
                                        <p>
                                            <small>
                                                <strong>Posted on
                                                    {{ \Carbon\Carbon::parse($tweetData->tweet_data->created_at)->toDayDateTimeString() }}
                                                </strong>
                                            </small>
                                        </p>
                                        <p>
                                            <i class="fa fa-retweet text-primary"></i>
                                            {{ $tweetData->tweet_data->retweet_count }}
                                            &nbsp;&nbsp;
                                            <i class="fa fa-heart text-danger"></i>
                                            {{ $tweetData->tweet_data->favorite_count }}
                                        </p>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <td>
                            <h3>
                                Most Recent Replies to<br />
                                Tweets
                            </h3>
                            <table class="table shadow bg-white table-hover table-striped">
                                @foreach(array_slice(json_decode($high_tweets['most_recent_replies']), 0, 5) as
                                $tweetData)
                                <tr>
                                    <td class="high-tweets" width="70%">
                                        <div class="media mb-3">
                        ...
                        <td>
                            <h3>
                                Highest Retweeted<br />
                                Tweets
                            </h3>
                            <table class="table shadow bg-white table-hover table-striped">
                                @foreach(array_slice(json_decode($high_tweets['highest_retweeted_tweets']), 0, 5) as
                                $tweetData)
                                <tr>
                                    <td class="high-tweets" width="70%">
                                        <div class="media mb-3">
                                            ...
                                            <div class="media-body">
                                                <strong>{{ '@'.$tweetData->user->screen_name }}</strong><br />
                                        ...
                                        <p>
                                            <small>
                                                <strong>Posted on
                                                    {{ \Carbon\Carbon::parse($tweetData->created_at)->toDayDateTimeString() }}
                                                </strong>
                                            </small>
                                        </p>
                                        <p>
                            ...
                            <div class="row gap-y align-items-center">
                                <div class="col-6 text-right order-lg-last">
                                    <div class="social">
                                        <a target="_blank" class="social-linkedin"
                                            href="https://www.linkedin.com/company/viral-get-ng"><i
                                                class="fa fa-linkedin"></i></a>
                                        <a target="_blank" class="social-twitter"
                                            href="https://twitter.com/viralget_ng"><i class="fa fa-twitter"></i></a>
                                        <a target="_blank" class="social-instagram"
                                            href="https://www.instagram.com/viralget_ng"><i
                                ...
                                <div class="col-lg-6">
                                    <a href="{{ route('home') }}"><img
                                            src="https://res.cloudinary.com/viralget/image/upload/v1597398871/logo-dark_fjwhan.png"
                                            alt="logo"></a>
                                </div>
