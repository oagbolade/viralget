...
<body>
  <div class="container">
    <table class="table table-borderless">
      <tbody>
        <tr>
          ...
          <td> 
            <br>               
            <span class="small text-uppercase ls-2">{{$data["report_days"]}} days report for the keyword: {{$data["handle"]}}</span>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="report-overview table table-borderless">
      <tbody>
        <tr>
          <td>
            <div class="col-md-4">
          ...
          <td> 
            <div class="col-md-4">
                ...
                >
                  {{$data["potential_reach"]}}
                </p>
            </div>
          </td>
          <td>
            <div class="col-md-4">
                <p class="small text-uppercase ls-2">CampaignValue</p>
                <p class="lead-8 lh-1 fw-700 counted" data-prefix="%">
                   N{{$data["campaign_value"]}}
                </p>
            </div>
          </td>
        </tr>
                ...
                <div class="row">
                  <div class="col-3">
                    <h4
                      ...
                      data-from="0"
                    >
                      {{$data["avr_contribution"]}}
                    </h4>
                  </div>

                  <div class="col-8 text-right mr-1">
                    <p class="small text-uppercase ls-2 mb-2">
                      <br />Avg Contribution <br />
                    </p>
                    <p><i class="icon-chat lead-4 mb-0"></i></p>
                  </div>
                </div>
            ...
            <div class="col-md-4">
              ...
              <table class="table bg-white shadow table-hover table-striped">
                <paginate
                  ...
                  tag="tbody"
                >
                 @foreach($data["top_contributors"] as $tweetData)
                  <tr
                    ...
                    <td width="70%">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <strong>{{$tweetData["user"]["screen_name"]}}</strong
                          ><br /><small>{{$tweetData["user"]["name"]}}</small>
                        </div>
                      </div>
                    </td>
                    <td class="text-center">
                      <strong>{{$tweetData["count"]}}</strong
            ...
            <div class="col-md-4">
              ...
              <table class="table bg-white shadow table-hover table-striped">
                <paginate
                  ...
                  tag="tbody"
                >
                @foreach($data["top_retweeters"] as $tweetData)
                  <tr
                    v-for="(active, index) in paginated('high_impacts')"
                    :key="index"
                  >
            ...
            <div class="col-md-4">
              ...
              <table class="table shadow bg-white table-hover table-striped">
                <paginate
                  ...
                  tag="tbody"
                >
                @foreach($data["highest_impacts"] as $tweetData)
                  <tr
                    v-for="(active, index) in paginated('high_impacts')"
                    :key="index"
                  >
                  ...
                  >
                    <td width="70%">
                      <div class="media">
                        ...
                        <div class="media-body">
                          <strong>@dayo_daved</strong
                          ><br /><small>Agbolade Oladayo</small>
                        </div>
                      </div>
                    </td>
                    <td class="text-center">
